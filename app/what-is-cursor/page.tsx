      ...
      <div className="prose prose-invert max-w-none prose-base md:prose-lg">
        ...
        <div className="space-y-4">
          <div className="bg-white/[0.02] rounded-xl p-4 md:p-6 backdrop-blur-sm hover:bg-white/[0.04] transition-colors">
            <p className="font-semibold text-violet-300 mb-2 text-base md:text-lg">Not an Extension</p>
            <p className="text-white/80 text-sm md:text-base">Cursor is a standalone IDE, unlike GitHub Copilot which functions as a plugin for existing editors.</p>
          </div>

          <div className="bg-white/[0.02] rounded-xl p-4 md:p-6 backdrop-blur-sm hover:bg-white/[0.04] transition-colors">
            <p className="font-semibold text-violet-300 mb-2 text-base md:text-lg">Not Autonomous</p>
            <p className="text-white/80 text-sm md:text-base">Cursor is a development tool that assists with coding tasks. It requires developer oversight and expertise to produce optimal results.</p>
          </div>

          <div className="bg-white/[0.02] rounded-xl p-4 md:p-6 backdrop-blur-sm hover:bg-white/[0.04] transition-colors">
            <p className="font-semibold text-violet-300 mb-2 text-base md:text-lg">Technical Limitations</p>
